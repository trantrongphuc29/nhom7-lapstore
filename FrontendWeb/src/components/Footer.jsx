        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button className="flex items-center bg-[#00ccff] text-white px-3 py-2 rounded-lg text-sm font-bold hover:bg-[#67adce] transition-all focus:outline-none focus:ring-2 focus:ring-[#00ccff] ">Gửi</button>
            </div>
          </div>
        </div>
